...
class LoginBindings implements Bindings {
  @override
  void dependencies() {
    Get.lazyPut(() => LoginRepositoryImpl(clientHttp: Get.find<ClientHttp>()));
    Get.lazyPut(() =>
        LoginServiceImpl(loginRepository: Get.find<LoginRepositoryImpl>()));
    Get.lazyPut(
      () => LoginController(
          loginService: Get.find<LoginServiceImpl>(),
          sharedPreferencesService: Get.find<SharedPreferencesService>()),fenix: true
    );
  }
}
